...
namespace DiamondLuxurySolution.AdminCrewApp.Controllers
{
    public class ManagerController : Controller
    {
        ...
        public ManagerController(IStaffApiService staffApiService, IRoleApiService roleApiService)
        {
        ...
        public async Task<IActionResult> Index(ViewStaffPaginationCommonRequest request)
        {
            try
            {
                ...
                var Staff = await _staffApiService.ViewManagerPagination(request);
