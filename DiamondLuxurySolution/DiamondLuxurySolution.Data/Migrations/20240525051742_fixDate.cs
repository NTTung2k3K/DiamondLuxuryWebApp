        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryPriceProcessing = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaterialPriceLists_Materials_MaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<string>(type: "nvarchar(15)", nullable: false),
                    MainGemQuantity = table.Column<int>(type: "int", nullable: false),
                    SubGemQuantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
