...
namespace DiamondLuxurySolution.WebApp.Repository.Components.Home_NhanNam
{
    public class Home_NhanNamViewComponent : ViewComponent
    {
        private readonly IProductApiService _productApiService;
        private readonly ISlideApiService _slideApiService;

        public Home_NhanNamViewComponent(IProductApiService productApiService, ISlideApiService slideApiService)
        {
